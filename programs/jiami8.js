// ========== character library definitions (escaping fixed) ==========
        ...
        // implementation note
        // encoding rule:01:00001-11111(character1-31), 10:00000-11111(character32-63), 11:00000-11111(character64-95)
        ...
        function bitEncodeChar(char) {
            ...
            // sub-library codeswap 10↔11,01unchanged
            let newLib = code.lib;
            if (code.lib === '10') newLib = '11';
            else if (code.lib === '11') newLib = '10';
            // index codebit transform (5th bit unchanged)
        ...
        // ========== v8 complete encryption flow ==========
        // 0.bit encoding → 1.Triple rotating libraries → 2.position shuffle+reverse → 3.chained avalanche → 4.column transposition
        function encryptV8(text, numKey, textKey, initialStateCode) {
        ...
        // ========== v8 complete decryption flow ==========
        // implementation note
        function decryptV8(ciphertext, textKey, numKey, stateCode) {
        ...
        encryptBtn.addEventListener('click', function() {
            ...
            try {
                const result = encryptV8(plaintext, numKey, textKey, libStatus);
                // display preview
        ...
        decryptBtn.addEventListener('click', function() {
            ...
            try {
                const result = decryptV8(ciphertext, textKey, numKey, stateCode);
                if (result.success) {
