// ========== character library definitions ==========
        ...
        // ========== v12 complete encryption flow ==========
        // implementation note
        function encryptV12(text, numKey, textKey, noiseKey, shaKey, cbcKey, initialStateCode, phantomN, phantomM) {
            // Step 0: CBCXOR chain
        ...
        // ========== v12 complete decryption flow ==========
        // implementation note
        function decryptV12(ciphertext, textKey, numKey, noiseKey, shaKey, cbcKey, stateCode, phantomN, phantomM) {
            // implementation note
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('encrypt-btn').addEventListener('click', function() {
                ...
                try {
                    const result = encryptV12(plaintext, numKey, textKey, noiseKey, shaKey, cbcKey, initialStateCode, phantomN, phantomM);
                    document.getElementById('encrypted-result').textContent = result.ciphertext;
                    document.getElementById('key-info-result').textContent = 'Library state code: ' + result.stateCode + ' | CBC key: ' + cbcKey + ' | SHA key: ' + shaKey + ' | Numeric key: ' + numKey + ' | Text key: ' + textKey + ' | Noise seed: ' + noiseKey + ' | Phantom intervalN: ' + phantomN + ' | Phantom lengthM: ' + phantomM;
            ...
            document.getElementById('decrypt-btn').addEventListener('click', function() {
                ...
                try {
                    const result = decryptV12(ciphertext, textKey, numKey, noiseKey, shaKey, cbcKey, stateCode, phantomN, phantomM);
